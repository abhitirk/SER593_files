...
$LOCAL_ROOT         = '../';
$LOCAL_REPO_NAME    = "3";
$LOCAL_REPO         = "../pull_folder/3";
$REMOTE_REPO        = "https://github.com/software-enterprise-asu/3.git";
$BRANCH             = "master";
...
if ($_SERVER['HTTP_X_GITHUB_EVENT'] == 'push') {
  ...
  if( file_exists($LOCAL_REPO) ) {
    ...
    shell_exec("cd 3 && git pull");
    die("done " . mktime());
  } else {

    // If the repo does not exist, then clone it into the parent directory
	shell_exec("git clone https://github.com/software-enterprise-asu/3.git 3"); 
    die("done " . mktime());
 }
}
?>