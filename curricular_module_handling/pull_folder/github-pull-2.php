...
/** 
  ...
  * 
  * Read more about how to use this script at http://behindcompanies.com/2024/02/a-simple-script-for-deploying-code-with-githubs-webhooks/
  * 
  * INSTRUCTIONS:
...
$LOCAL_ROOT         = '../';
$LOCAL_REPO_NAME    = "2";
$LOCAL_REPO         = "../pull_folder/2";
$REMOTE_REPO        = "https://github.com/software-enterprise-asu/2.git";
$BRANCH             = "master";
...
if ($_SERVER['HTTP_X_GITHUB_EVENT'] == 'push') {
  ...
  if( file_exists($LOCAL_REPO) ) {
    ...
    shell_exec("cd 2 && git pull");
    die("done " . mktime());
  } else {

    // If the repo does not exist, then clone it into the parent directory
	shell_exec("git clone https://github.com/software-enterprise-asu/2.git 2"); 
    die("done " . mktime());
 }
}
?>